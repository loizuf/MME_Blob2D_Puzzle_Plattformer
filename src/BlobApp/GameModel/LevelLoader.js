BlobApp.LevelLoader = (function() {
	...
	_createRedBlob = function(x,y){
		...
		console.log(blob);
		$('body').trigger('blobRequested',blob.sprite, EntityConfig.REDBLOBID);
	},

	_createGreenBlob = function(x, y){
		var blob = new BlobApp.Blob(x, y, 25, 25, EntityConfig.GREENBLOBID);
		console.log(blob);
		$('body').trigger('blobRequested',blob.sprite, EntityConfig.GREENBLOBID);
	},
